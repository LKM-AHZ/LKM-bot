...
Open the LKMBot dashboard and go to **Providers → Chat Completion → Add → MiraRouter**. Enter the following values:
...
LKMBot automatically adds the `X-APP-CODE: astrbot` identifier to MiraRouter requests.
