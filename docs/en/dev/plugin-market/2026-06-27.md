# LKMBot Plugin Market JSON Specification
...
This document defines the JSON format for LKMBot plugin market sources.
...
```json
{
  "$meta": {
    "schema_version": 1,
    "name": "LKMBot Official Plugin Market",
    "version": "2026-06-27",
...
- `plugin_id` MUST be globally unique across the LKMBot plugin ecosystem.
...
| `astrbot_version`   | string   | LKMBot version requirement expression.                                            |
