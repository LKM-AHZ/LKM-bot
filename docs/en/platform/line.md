...
- `LINE Bot User ID`: optional; if empty, LKMBot uses webhook `destination`
...
> [!TIP]
> If LKMBot is not publicly reachable, set up a public domain and reverse proxy first so LINE can access your webhook URL.
