...
An Agent Runner is the component in LKMBot that executes Agent capabilities and handles AI-related workflows.

LKMBot includes a powerful built-in Agent Runner. You can also integrate third-party Agent Runner services like Dify, Coze, Alibaba Bailian, and DeerFlow, or build your own.
