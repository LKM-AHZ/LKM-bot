# Deploy LKMBot on 1Panel

[1Panel](https://1panel.cn/) is an open-source next-generation Linux server operation and management panel.

LKMBot has been published to the [1Panel App Store](https://apps.fit2cloud.com/1panel) by the 1Panel team, allowing users to quickly deploy and use it directly through 1Panel.
...
Open the 1Panel panel, go to the 1Panel App Store, and search for `LKMBot`, as shown below.

![image](https://files.astrbot.app/docs/source/images/1panel/image.png)

Click `Install` and wait for the installation to complete.

After successful installation, open the corresponding LKMBot port (default is 6185) in the 1Panel System-Firewall page.
